...
export default function Company(){
    return(
       ...
       <div className="sideBar">
        ...
        <div className='SectionSeventext textalign'>Find critical answers for all things <br/> Salesforce - search resources, browse <br/> documentation, log cases, and more
        </div> 
